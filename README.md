...
The example uses the `java:jboss/datasources/PostgreSQLDS` database, configured and deployed by the application.
...
4. This will deploy `target/homerenting-webapp.war` to the running instance of the server.


Access the application 
---------------------
 
The application will be running at the following URL: <http://localhost:8080/homerenting-webapp/>.
