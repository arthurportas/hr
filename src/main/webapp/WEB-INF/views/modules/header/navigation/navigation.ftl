        ...
        <div class="container">
            ...
            <div class="nav-collapse collapse">
                <ul class="nav">
                    ...
                    <li><a href="#" title="<@spring.messageText "NEWS", "Notícias"/>"><@spring.messageText "NEWS", "Notícias"/></a></li>
                    <li><a href="#" title="<@spring.messageText "PROFESSIONALS", "Profissionais"/>"><@spring.messageText "PROFESSIONALS", "Profissionais"/></a></li>
                    <li><a href="#" title="<@spring.messageText "FINANCING", "Financiamento"/>"><@spring.messageText "FINANCING", "Financiamento"/></a></li>

                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Legislação<i class="icon-caret-down"></i></a>
                        <ul class="dropdown-menu">
                            <li><a href="#" title="Typography">Venda</a></li>
                            <li><a href="tabs-and-toggle.html" title="Tabs and Toggle">Arrendamento</a></li>
                        </ul>
                    </li>
